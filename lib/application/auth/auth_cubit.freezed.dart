...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AppError failure) failure,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AppError failure)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$AuthenticatedImpl implements _Authenticated {
  const _$AuthenticatedImpl(this.firebaseUser);
...
abstract class _Authenticated implements AuthState {
  const factory _Authenticated(final User firebaseUser) = _$AuthenticatedImpl;
...
abstract class _Failure implements AuthState {
  const factory _Failure(final AppError failure) = _$FailureImpl;
